...
class LoginPageTrainer extends StatefulWidget {
  const LoginPageTrainer({super.key});

  @override
  State<LoginPageTrainer> createState() => _LoginPageTrainerState();
}

class _LoginPageTrainerState extends State<LoginPageTrainer>
  ...
  Widget build(BuildContext context) {
    final authProvider = Provider.of<AuthProviderTrainer>(context);
